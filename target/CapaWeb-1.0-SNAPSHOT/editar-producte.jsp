...
<body>
    ...
    <main class="contenidor">
        <h1>Editar/Nou Producte</h1>
        
        <div class="formulari-contenidor">
            <form method="post" action="guardarProducte.jsp">
                <fieldset class="fieldset">
                    ...
                    <div class="fila-camps">
                        <div class="grup-camp">
                            ...
                            <input type="text" id="codiProducte" name="codiProducte" class="camp" 
                                   placeholder="PRD-XXX" maxlength="20" required>
                        </div>
                    ...
                    <div class="grup-camp">
                        ...
                        <input type="text" id="nomProducte" name="nomProducte" class="camp" 
                               maxlength="100" required>
                    </div>
                    
                    <div class="grup-camp">
                        <label class="etiqueta" for="descripcioProducte">DESCRIPCIÓ DEL PRODUCTE</label>
                        <textarea id="descripcioProducte" name="descripcioProducte" 
                                  class="camp textarea" rows="5"></textarea>
                    </div>
                </fieldset>
                
                <div class="grup-botons">
                    <a href="productes.jsp" class="boto boto-secundari">CANCELAR</a>
